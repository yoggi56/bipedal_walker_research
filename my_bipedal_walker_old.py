...
class BipedalWalker(gym.Env, EzPickle):
    ...
    def __init__(self, learn=True, vel_ctrl=False):
        ...
        high = np.array([np.inf] * OBS_LENGTH).astype(np.float32) 
    ...
    def _generate_terrain(self, hardcore):
        ...
        for i in range(TERRAIN_LENGTH):
            ...
            elif state == STUMP1 and oneshot: #(state == STUMP1 or state == STUMP2 or state == STUMP3 or state == STUMP4) and oneshot: #
    ...
    def step(self, action):
        ...
        # # ------------------------------------
        # # -- my part of the reward function --
        # # ------------------------------------
        # #reward -= 5*abs(0.3-state[2])**2/SCALE
